...
def run_auto_game(team1_spec: str, team2_spec: str, delay: float = 0.0):
    ...
    if not team1_path:
        ...
        print(f"  Examples:")
        print(f"    python -m paydirt -auto Bears Cowboys")
        print(f"    python -m paydirt -auto 1983/Bears 1983/Cowboys")
        print(f"    python -m paydirt -auto seasons/1983/Bears seasons/1983/Cowboys")
        return
    ...
    print("=" * 70)
    print(f"  PAYDIRT - CPU vs CPU SIMULATION")
    print("=" * 70)
