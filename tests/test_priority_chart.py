...
class TestWhiteNumberOffense:
    ...
    def test_white_vs_red(self):
        """White # vs Red # should ADD (negative + zero = negative)."""
...
class TestINTOffense:
    ...
    def test_int_vs_black(self):
        """INT vs BLACK should be incomplete (per priority chart: INT + BLACK = INC)."""
...
class TestFumblePlusOffense:
    ...
    def test_fumble_plus_vs_red(self):
        """F+# vs Red # should use FUMBLE (fumble always wins, use offense yards)."""
