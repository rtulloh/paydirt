"""
Pytest configuration and shared fixtures for paydirt tests.
"""
import os
...
def season_data_exists(year: int, team: str = None) -> bool:
    ...
    possible_base_paths = [
        Path(__file__).parent.parent / 'seasons',
...
HAS_1972_DOLPHINS = season_data_exists(1972, 'Dolphins')
